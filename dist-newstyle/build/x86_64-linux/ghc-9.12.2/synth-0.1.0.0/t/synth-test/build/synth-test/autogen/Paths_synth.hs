...
-- at runtime using the environment variable synth_bindir.
...
-- environment variable synth_libdir.
...
-- using the environment variable synth_dynlibdir.
...
-- runtime using the environment variable synth_datadir.
...
-- using the environment variable synth_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33/synth-0.1.0.0-inplace-synth-test"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.12.2-9b33"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.12.2-9b33/synth-0.1.0.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.12.2-9b33/synth-0.1.0.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "synth_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "synth_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "synth_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "synth_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "synth_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "synth_sysconfdir") (\_ -> return sysconfdir)
